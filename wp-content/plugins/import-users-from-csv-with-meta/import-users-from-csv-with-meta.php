...
function acui_admin_tabs( $current = 'homepage' ) {
    $tabs = array( 'homepage' => 'Import users from CSV', 'columns' => 'Customs columns loaded', 'doc' => 'Documentation', 'cron' => 'Cron import', 'donate' => 'Donate', 'shop' => 'Shop', 'help' => 'Hire an expert' );
